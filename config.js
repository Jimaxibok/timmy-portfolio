module.exports = {
  ...
  tags: {
    ...
    indicina: {
      ...
      description: 'A fully responsive React built website for Indicina, UI adapted from already hosted website',
      color: '#fed304',
    ...
    originate: {
      ...
      description: 'A dashboard system for a Financial Institution built using React and Antd  [Front End only]',
      color: '#00373e7',
    ...
    moneyvest: {
      ...
      description: 'A financial web application, built using ReactJS, Redux. Consists of a Website and User Dashboard',
      color: '#000',
    ...
    imageprocessing: {
      ...
      description: 'A python application using the PIL library allows you to filter, crop and process high resolution images for your app as well as conversion from JPG to PNG and vice versa',
      color: '#013444',
    ...
    passwordkeeper: {
      ...
      description: 'Similar to "haveibeenpwned.com" this Software checks if your password has been hacked by using an hash algorithm as well as python libraries',
      color: '#C78056',
    ...
    pygame: {
      name: 'pygame',
      projectName: 'PyGame',
      description: 'Exciting repositiory containing a collection of real world projects and games built using python which includes Blackjack, Snake, Pong, etc.',
      color: '#EB6365',
